...
export interface RegistryServiceInterface {
    ...
    * @param overwrite 
    */
    installPlugin(file: Blob, overwrite?: boolean, extraHttpRequestParams?: any): Observable<object>;
    ...
    */
    uninstallPlugin(plugin: string, pluginUninstall?: PluginUninstall, extraHttpRequestParams?: any): Observable<object>;
