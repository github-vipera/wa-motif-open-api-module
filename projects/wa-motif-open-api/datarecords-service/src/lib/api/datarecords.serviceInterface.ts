...
export interface DatarecordsServiceInterface {
    ...
    * @param singleCsv Default value is true
    */
    verifyDatarecordsExport(type: string, hashedSession?: string, usersId?: number, operations?: Array<string>, fromDate?: Date, toDate?: Date, resultCode?: string, anyError?: boolean, singleCsv?: boolean, extraHttpRequestParams?: any): Observable<object>;
