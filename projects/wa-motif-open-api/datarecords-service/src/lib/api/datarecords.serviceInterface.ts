...
export interface DatarecordsServiceInterface {
    ...
    */
    exportDatarecords(type: string, hashedSession?: string, usersId?: number, operations?: Array<string>, fromDate?: string, toDate?: string, resultCode?: string, anyError?: boolean, singleCsv?: boolean, extraHttpRequestParams?: any): Observable<Blob>;
    ...
    */
    getDatarecords(type: string, fromDate?: string, toDate?: string, page?: number, pageSize?: number, sort?: string, extraHttpRequestParams?: any): Observable<DatarecordList>;

    /**
    * Retrieve datarecords types
    * Retrieve datarecords types
    */
    getDatarecordsTypes(extraHttpRequestParams?: any): Observable<DatarecordTypesList>;
    ...
    * @param singleCsv Default value is true
    */
    verifyDatarecordsExport(type: string, hashedSession?: string, usersId?: number, operations?: Array<string>, fromDate?: string, toDate?: string, resultCode?: string, anyError?: boolean, singleCsv?: boolean, extraHttpRequestParams?: any): Observable<any>;
