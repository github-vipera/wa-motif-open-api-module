...
export interface DomainsServiceInterface {
    ...
    */
    deleteDomain(domain: string, extraHttpRequestParams?: any): Observable<object>;
    ...
    * @param domainUpdate 
    */
    updateDomain(domain: string, domainUpdate?: DomainUpdate, extraHttpRequestParams?: any): Observable<object>;
