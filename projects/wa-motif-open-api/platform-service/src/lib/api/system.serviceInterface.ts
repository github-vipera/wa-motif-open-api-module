...
export interface SystemServiceInterface {
    ...
    * @param category System Category Name
    */
    deleteSystemCategory(domain: string, category: string, extraHttpRequestParams?: any): Observable<object>;
    ...
    */
    deleteSystemMessage(domain: string, category: string, locale: string, extraHttpRequestParams?: any): Observable<object>;
    ...
    */
    updateSystemMessage(domain: string, category: string, locale: string, systemMessageUpdate?: SystemMessageUpdate, extraHttpRequestParams?: any): Observable<object>;
