...
export class ApplicationsService implements ApplicationsServiceInterface {
    ...
    public deleteApplication(domain: string, application: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/platform/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateApplication(domain: string, application: string, applicationUpdate?: ApplicationUpdate, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateApplication(domain: string, application: string, applicationUpdate?: ApplicationUpdate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateApplication(domain: string, application: string, applicationUpdate?: ApplicationUpdate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateApplication(domain: string, application: string, applicationUpdate?: ApplicationUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/platform/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}`,
            applicationUpdate,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
