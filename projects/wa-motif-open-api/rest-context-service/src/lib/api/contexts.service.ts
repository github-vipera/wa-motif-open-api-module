...
export class ContextsService implements ContextsServiceInterface {
    ...
    public createContext(domain: string, application: string, restContextCreate?: RestContextCreate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<ServiceContext>(`${this.configuration.basePath}/restctx/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts`,
            restContextCreate,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteContext(domain: string, application: string, contextName: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public deleteContext(domain: string, application: string, contextName: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public deleteContext(domain: string, application: string, contextName: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public deleteContext(domain: string, application: string, contextName: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/restctx/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts/${encodeURIComponent(String(contextName))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getContext(domain: string, application: string, contextName: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<ServiceContext>(`${this.configuration.basePath}/restctx/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts/${encodeURIComponent(String(contextName))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getContexts(domain: string, application: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<ServiceContext>>(`${this.configuration.basePath}/restctx/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateContext(domain: string, application: string, contextName: string, restContextUpdate?: RestContextUpdate, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateContext(domain: string, application: string, contextName: string, restContextUpdate?: RestContextUpdate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateContext(domain: string, application: string, contextName: string, restContextUpdate?: RestContextUpdate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateContext(domain: string, application: string, contextName: string, restContextUpdate?: RestContextUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/restctx/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts/${encodeURIComponent(String(contextName))}`,
            restContextUpdate,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
