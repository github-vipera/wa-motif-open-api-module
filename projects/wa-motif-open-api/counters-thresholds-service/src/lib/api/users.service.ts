...
export class UsersService implements UsersServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUserCounter(counterInfo: string, domain: string, userId: string, variation?: Variation, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public updateUserCounter(counterInfo: string, domain: string, userId: string, variation?: Variation, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public updateUserCounter(counterInfo: string, domain: string, userId: string, variation?: Variation, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public updateUserCounter(counterInfo: string, domain: string, userId: string, variation?: Variation, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<object>(`${this.configuration.basePath}/countersthresholds/domain/${encodeURIComponent(String(domain))}/user/${encodeURIComponent(String(userId))}/counters/${encodeURIComponent(String(counterInfo))}`,
            variation,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
