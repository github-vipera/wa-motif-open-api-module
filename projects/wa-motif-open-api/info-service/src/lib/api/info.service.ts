...
export class InfoService implements InfoServiceInterface {
     ...
     */
    public getChannelInfo(channel: string, observe?: 'body', reportProgress?: boolean): Observable<ChannelInfo>;
    public getChannelInfo(channel: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ChannelInfo>>;
    public getChannelInfo(channel: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ChannelInfo>>;
    public getChannelInfo(channel: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<ChannelInfo>(`${this.configuration.basePath}/info/realtime/channel/${encodeURIComponent(String(channel))}`,
            {
