...
export interface AdminsServiceInterface {
    ...
    */
    createAdminUserCredentials(domain: string, userId: string, credentialsCreate?: CredentialsCreate, extraHttpRequestParams?: any): Observable<object>;
    ...
    * @param userId User Id
    */
    deleteAdminUser(domain: string, userId: string, extraHttpRequestParams?: any): Observable<object>;
    ...
    */
    updateAdminUser(domain: string, userId: string, adminUserUpdate?: AdminUserUpdate, extraHttpRequestParams?: any): Observable<object>;
    ...
    */
    updateAdminUserCredentials(domain: string, userId: string, credentialsUpdate?: CredentialsUpdate, extraHttpRequestParams?: any): Observable<object>;
