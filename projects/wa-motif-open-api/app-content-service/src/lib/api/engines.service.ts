...
export class EnginesService implements EnginesServiceInterface {
    ...
    public deleteEngine(domain: string, engine: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/${encodeURIComponent(String(engine))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public deleteTrackedEnginesVersions(domain: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/tracking/versions`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateEngine(domain: string, engine: string, engineUpdate?: EngineUpdate, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateEngine(domain: string, engine: string, engineUpdate?: EngineUpdate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateEngine(domain: string, engine: string, engineUpdate?: EngineUpdate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateEngine(domain: string, engine: string, engineUpdate?: EngineUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/${encodeURIComponent(String(engine))}`,
            engineUpdate,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
