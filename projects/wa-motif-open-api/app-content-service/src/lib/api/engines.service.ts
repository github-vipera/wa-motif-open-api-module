...
export class EnginesService implements EnginesServiceInterface {
     ...
     */
    public checkEngine(domain: string, engine: string, appCheckRequest?: AppCheckRequest, observe?: 'body', reportProgress?: boolean): Observable<AppCheckResponse>;
    public checkEngine(domain: string, engine: string, appCheckRequest?: AppCheckRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AppCheckResponse>>;
    public checkEngine(domain: string, engine: string, appCheckRequest?: AppCheckRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AppCheckResponse>>;
    public checkEngine(domain: string, engine: string, appCheckRequest?: AppCheckRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<AppCheckResponse>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/${encodeURIComponent(String(engine))}/check`,
            appCheckRequest,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createEngine(domain: string, engineCreate?: EngineCreate, observe?: 'body', reportProgress?: boolean): Observable<Engine>;
    public createEngine(domain: string, engineCreate?: EngineCreate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Engine>>;
    public createEngine(domain: string, engineCreate?: EngineCreate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Engine>>;
    public createEngine(domain: string, engineCreate?: EngineCreate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (domain === null || domain === undefined) {
        ...
        return this.httpClient.post<Engine>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines`,
            engineCreate,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteEngine(domain: string, engine: string, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public deleteEngine(domain: string, engine: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public deleteEngine(domain: string, engine: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public deleteEngine(domain: string, engine: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<object>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/${encodeURIComponent(String(engine))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteTrackedEnginesVersions(domain: string, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public deleteTrackedEnginesVersions(domain: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public deleteTrackedEnginesVersions(domain: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public deleteTrackedEnginesVersions(domain: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<object>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/tracking/versions`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getEngine(domain: string, engine: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Engine>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/${encodeURIComponent(String(engine))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getTrackedEngineVersions(domain: string, engine: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<string>>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/${encodeURIComponent(String(engine))}/tracking/versions`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateEngine(domain: string, engine: string, engineUpdate?: EngineUpdate, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public updateEngine(domain: string, engine: string, engineUpdate?: EngineUpdate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public updateEngine(domain: string, engine: string, engineUpdate?: EngineUpdate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public updateEngine(domain: string, engine: string, engineUpdate?: EngineUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (domain === null || domain === undefined) {
        ...
        return this.httpClient.put<object>(`${this.configuration.basePath}/appcont/domains/${encodeURIComponent(String(domain))}/engines/${encodeURIComponent(String(engine))}`,
            engineUpdate,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
