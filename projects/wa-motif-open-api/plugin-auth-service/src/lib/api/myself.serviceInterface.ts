...
export interface MyselfServiceInterface {
    ...
    */
    changePasswd(userPasswordChange?: UserPasswordChange, extraHttpRequestParams?: any): Observable<object>;

    /**
    * Handles deactivation
    * Handles deactivation
    */
    deactivateUser(extraHttpRequestParams?: any): Observable<object>;
