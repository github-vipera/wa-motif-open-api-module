...
export class Oauth2Service implements Oauth2ServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public revoke(oAuthRequest?: OAuthRequest, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public revoke(oAuthRequest?: OAuthRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public revoke(oAuthRequest?: OAuthRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public revoke(oAuthRequest?: OAuthRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/oauth2/revoke`,
            oAuthRequest,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public validate(oAuthRequest?: OAuthRequest, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public validate(oAuthRequest?: OAuthRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public validate(oAuthRequest?: OAuthRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public validate(oAuthRequest?: OAuthRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/oauth2/validate`,
            oAuthRequest,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
