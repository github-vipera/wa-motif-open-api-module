...
export class DirectoriesService implements DirectoriesServiceInterface {
     ...
     */
    public deleteBundle(directory: string, bundle: string, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public deleteBundle(directory: string, bundle: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public deleteBundle(directory: string, bundle: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public deleteBundle(directory: string, bundle: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<object>(`${this.configuration.basePath}/fileinstall/directories/${encodeURIComponent(String(directory))}/bundles/${encodeURIComponent(String(bundle))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteBundles(directory: string, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public deleteBundles(directory: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public deleteBundles(directory: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public deleteBundles(directory: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<object>(`${this.configuration.basePath}/fileinstall/directories/${encodeURIComponent(String(directory))}/bundles`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public scanDirectory(directory: string, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public scanDirectory(directory: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public scanDirectory(directory: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public scanDirectory(directory: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<object>(`${this.configuration.basePath}/fileinstall/directories/${encodeURIComponent(String(directory))}/scan`,
            null,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
