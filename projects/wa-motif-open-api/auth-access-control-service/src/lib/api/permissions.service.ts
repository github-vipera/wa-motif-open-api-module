...
export class PermissionsService implements PermissionsServiceInterface {
    ...
    public deletePermission(permissionComponent: string, permissionAction: string, permissionTarget: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/acs/permissions/${encodeURIComponent(String(permissionComponent))}/${encodeURIComponent(String(permissionAction))}/${encodeURIComponent(String(permissionTarget))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
