...
export class GroupsService implements GroupsServiceInterface {
     ...
     */
    public assignRoleToGroup(domain: string, group: string, roleAssign?: RoleAssign, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public assignRoleToGroup(domain: string, group: string, roleAssign?: RoleAssign, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public assignRoleToGroup(domain: string, group: string, roleAssign?: RoleAssign, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public assignRoleToGroup(domain: string, group: string, roleAssign?: RoleAssign, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}/roles`,
            roleAssign,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createGroup(domain: string, groupCreate?: GroupCreate, observe?: 'body', reportProgress?: boolean): Observable<Group>;
    public createGroup(domain: string, groupCreate?: GroupCreate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Group>>;
    public createGroup(domain: string, groupCreate?: GroupCreate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Group>>;
    public createGroup(domain: string, groupCreate?: GroupCreate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (domain === null || domain === undefined) {
        ...
        return this.httpClient.post<Group>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups`,
            groupCreate,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public deleteGroup(domain: string, group: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getDomainGroups(domain: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Group>>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getGroup(domain: string, group: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Group>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getGroupActions(domain: string, group: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Action>>;
    public getGroupActions(domain: string, group: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Action>>>;
    public getGroupActions(domain: string, group: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Action>>>;
    public getGroupActions(domain: string, group: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (domain === null || domain === undefined) {
            throw new Error('Required parameter domain was null or undefined when calling getGroupActions.');
        }
        if (group === null || group === undefined) {
            throw new Error('Required parameter group was null or undefined when calling getGroupActions.');
        }
        ...
        return this.httpClient.get<Array<Action>>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}/actions`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getGroupPermissions(domain: string, group: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Permission>>;
    public getGroupPermissions(domain: string, group: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Permission>>>;
    public getGroupPermissions(domain: string, group: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Permission>>>;
    public getGroupPermissions(domain: string, group: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (domain === null || domain === undefined) {
            throw new Error('Required parameter domain was null or undefined when calling getGroupPermissions.');
        }
        if (group === null || group === undefined) {
            throw new Error('Required parameter group was null or undefined when calling getGroupPermissions.');
        }
        ...
        return this.httpClient.get<Array<Permission>>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}/permissions`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getGroupRoles(domain: string, group: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Role>>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}/roles`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getGroupUsers(domain: string, group: string, userId?: string, userIdInt?: string, page?: number, pageSize?: number, sort?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<User>>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}/users`,
            {
    ...
    public getGroups(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Group>>(`${this.configuration.basePath}/acs/domains/groups`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public removeRoleFromGroup(domain: string, group: string, role: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}/roles/${encodeURIComponent(String(role))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateGroup(domain: string, group: string, groupUpdate?: GroupUpdate, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateGroup(domain: string, group: string, groupUpdate?: GroupUpdate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateGroup(domain: string, group: string, groupUpdate?: GroupUpdate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateGroup(domain: string, group: string, groupUpdate?: GroupUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (domain === null || domain === undefined) {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/groups/${encodeURIComponent(String(group))}`,
            groupUpdate,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
