...
export class UsersService implements UsersServiceInterface {
     ...
     */
    public assignGroupToUser(domain: string, userId: string, groupAssign?: GroupAssign, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public assignGroupToUser(domain: string, userId: string, groupAssign?: GroupAssign, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public assignGroupToUser(domain: string, userId: string, groupAssign?: GroupAssign, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public assignGroupToUser(domain: string, userId: string, groupAssign?: GroupAssign, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<object>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/users/${encodeURIComponent(String(userId))}/groups`,
            groupAssign,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public assignRoleToUser(domain: string, userId: string, roleAssign?: RoleAssign, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public assignRoleToUser(domain: string, userId: string, roleAssign?: RoleAssign, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public assignRoleToUser(domain: string, userId: string, roleAssign?: RoleAssign, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public assignRoleToUser(domain: string, userId: string, roleAssign?: RoleAssign, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (domain === null || domain === undefined) {
        ...
        return this.httpClient.post<object>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/users/${encodeURIComponent(String(userId))}/roles`,
            roleAssign,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getUserGroups(domain: string, userId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Group>>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/users/${encodeURIComponent(String(userId))}/groups`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getUserPermissions(domain: string, userId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Permission>>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/users/${encodeURIComponent(String(userId))}/permissions`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getUserRoles(domain: string, userId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Role>>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/users/${encodeURIComponent(String(userId))}/roles`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public isUserPermissionEntitled(domain: string, userId: string, permissionComponent: string, permissionAction: string, permissionTarget: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<EntitlementResult>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/users/${encodeURIComponent(String(userId))}/permissions/${encodeURIComponent(String(permissionComponent))}/${encodeURIComponent(String(permissionAction))}/${encodeURIComponent(String(permissionTarget))}/entitled`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public removeGroupFromUser(domain: string, userId: string, group: string, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public removeGroupFromUser(domain: string, userId: string, group: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public removeGroupFromUser(domain: string, userId: string, group: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public removeGroupFromUser(domain: string, userId: string, group: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<object>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/users/${encodeURIComponent(String(userId))}/groups/${encodeURIComponent(String(group))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public removeRoleFromUser(domain: string, userId: string, role: string, observe?: 'body', reportProgress?: boolean): Observable<object>;
    public removeRoleFromUser(domain: string, userId: string, role: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<object>>;
    public removeRoleFromUser(domain: string, userId: string, role: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<object>>;
    public removeRoleFromUser(domain: string, userId: string, role: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<object>(`${this.configuration.basePath}/acs/domains/${encodeURIComponent(String(domain))}/users/${encodeURIComponent(String(userId))}/roles/${encodeURIComponent(String(role))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
