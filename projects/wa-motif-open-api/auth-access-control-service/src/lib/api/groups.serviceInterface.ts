...
export interface GroupsServiceInterface {
    ...
    * @param roleAssign 
    */
    assignRoleToGroup(domain: string, group: string, roleAssign?: RoleAssign, extraHttpRequestParams?: any): Observable<object>;
    ...
    * @param group Group Name
    */
    deleteGroup(domain: string, group: string, extraHttpRequestParams?: any): Observable<object>;
    ...
    */
    removeRoleFromGroup(domain: string, group: string, role: string, extraHttpRequestParams?: any): Observable<object>;
    ...
    * @param groupUpdate 
    */
    updateGroup(domain: string, group: string, groupUpdate?: GroupUpdate, extraHttpRequestParams?: any): Observable<object>;
