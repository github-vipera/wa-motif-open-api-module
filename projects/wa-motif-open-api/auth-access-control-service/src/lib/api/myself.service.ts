...
export class MyselfService implements MyselfServiceInterface {
    ...
    public getMyselfActions(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Action>>(`${this.configuration.basePath}/acs/myself/actions`,
            {
    ...
    public isMyselfActionEntitled(action: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<EntitlementResult>(`${this.configuration.basePath}/acs/myself/actions/${encodeURIComponent(String(action))}/entitled`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
