...
export class ContextsService implements ContextsServiceInterface {
    ...
    public deleteContext(domain: string, application: string, contextName: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/restcontent/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts/${encodeURIComponent(String(contextName))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public updateContext(domain: string, application: string, contextName: string, restContextUpdate?: RestContextUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/restcontent/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts/${encodeURIComponent(String(contextName))}`,
            restContextUpdate,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
