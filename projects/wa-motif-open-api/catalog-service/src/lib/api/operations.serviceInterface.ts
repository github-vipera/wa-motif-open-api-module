...
export interface OperationsServiceInterface {
    ...
    */
    deleteServiceOperation(channel: string, domain: string, application: string, service: string, operation: string, extraHttpRequestParams?: any): Observable<object>;
    ...
    */
    updateServiceOperation(channel: string, domain: string, application: string, service: string, operation: string, serviceOperationProperties?: ServiceOperationProperties, extraHttpRequestParams?: any): Observable<object>;
