...
export class ContextsService implements ContextsServiceInterface {
    ...
    public deleteContext(domain: string, application: string, contextName: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/webcontent/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts/${encodeURIComponent(String(contextName))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateContext(domain: string, application: string, contextName: string, webContentContextUpdate?: WebContentContextUpdate, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateContext(domain: string, application: string, contextName: string, webContentContextUpdate?: WebContentContextUpdate, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateContext(domain: string, application: string, contextName: string, webContentContextUpdate?: WebContentContextUpdate, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateContext(domain: string, application: string, contextName: string, webContentContextUpdate?: WebContentContextUpdate, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/webcontent/domains/${encodeURIComponent(String(domain))}/applications/${encodeURIComponent(String(application))}/contexts/${encodeURIComponent(String(contextName))}`,
