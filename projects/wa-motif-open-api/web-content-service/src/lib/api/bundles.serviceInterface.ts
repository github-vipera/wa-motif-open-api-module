...
export interface BundlesServiceInterface {
    ...
    * @param bundleVersion 
    */
    deleteBundle(bundleName: string, bundleVersion: string, extraHttpRequestParams?: any): Observable<any>;
    ...
    * @param bundleVersion 
    */
    publishBundle(bundleName: string, bundleVersion: string, extraHttpRequestParams?: any): Observable<any>;
    ...
    * @param bundleVersion 
    */
    unpublishBundle(bundleName: string, bundleVersion: string, extraHttpRequestParams?: any): Observable<any>;
    ...
    * @param bundleUpdate 
    */
    updateBundle(bundleName: string, bundleVersion: string, bundleUpdate?: BundleUpdate, extraHttpRequestParams?: any): Observable<any>;
    ...
    * @param overwrite 
    */
    uploadBundle(bundle: Blob, overwrite?: boolean, extraHttpRequestParams?: any): Observable<any>;
